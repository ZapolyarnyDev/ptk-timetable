...
object AppIcons {
    val course = Icons.Outlined.School
    ...
    val room = Icons.Outlined.LocationOn
    val edit = Icons.Outlined.Edit
    val note = Icons.AutoMirrored.Outlined.FormatListBulleted
    val notes = Icons.AutoMirrored.Outlined.Notes
    val reminder = Icons.Outlined.NotificationsActive
    val filter = Icons.Outlined.Tune
    val chevron = Icons.Outlined.ChevronRight
